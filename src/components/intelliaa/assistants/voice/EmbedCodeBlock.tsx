...
const EmbedCodeBlock: React.FC<EmbedCodeBlockProps> = ({ code }) => {
  ...
  return (
    <div className='flex flex-col w-[50%] min-h-[70vh] dark:bg-[#242322]/80 dark:border-gray-700 dark:shadow-[inset_0_0_20px_rgba(20,184,166,0.2)] overflow-hidden border rounded-sm p-4 justify-between'>
