                  ...
                  >
                    ...
                    {linePosition === "top" || linePosition === "bottom" ? (
                      ...
                      >
                        <div
                          ...
                          } origin-left bg-primary transition-all ease-linear dark:bg-primary`}
                          style={{
                            transitionDuration:
                              currentIndex === index
                                ? `${collapseDelay}ms`
                    ...
                    <AccordionTrigger>
                      <div className="flex items-center relative flex-col">
                        ...
                        <div className="font-bold text-xl my-3 bg-gradient-to-r from-[#14b8a6] to-[#14b8a6]/40 bg-clip-text text-transparent ">
                          {item.title}
                        </div>
                        <div className="justify-center text-center mb-4 text-muted-foreground">
                          {item.content}
                        </div>
                      </div>
                    </AccordionTrigger>
