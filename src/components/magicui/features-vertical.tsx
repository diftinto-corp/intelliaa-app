                ...
                {data.map((item, index) => (
                  ...
                  >
                    {linePosition === "left" || linePosition === "right" ? (
                      ...
                      >
                        <div
                          ...
                          } origin-top bg-primary transition-all ease-linear dark:bg-primary`}
                          style={{
                            transitionDuration:
                              currentIndex === index
                                ? `${collapseDelay}ms`
                    ...
                    <div className="flex items-center relative">
                      ...
                      <div>
                        <AccordionTrigger className="text-balance bg-gradient-to-br from-[#14b8a6] from-30% to-[#14b8a6]/60 bg-clip-text pt-2 text-5xl font-medium leading-none tracking-tighter text-transparent dark:from-[#14b8a6] dark:to-[#14b8a6]/40 sm:text-base md:text-lg lg:text-xl">
                          {item.title}
                        </AccordionTrigger>

                        <AccordionTrigger className="justify-start text-muted-foreground text-left leading-4 font-sans text-[16px]">
                          {item.content}
                        </AccordionTrigger>
                      </div>
                    </div>
