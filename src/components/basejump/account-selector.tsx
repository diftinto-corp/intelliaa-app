...
export default function AccountSelector({
  ...
  accountId,
  onAccountSelected,
  placeholder = "Seleccióna una organización",
    ...
    <Dialog open={showNewTeamDialog} onOpenChange={setShowNewTeamDialog}>
      <Popover open={open} onOpenChange={setOpen}>
        <PopoverTrigger asChild>
          <Button
            ...
            role='combobox'
            aria-expanded={open}
            aria-label='Sleccionar organización'
      ...
      <DialogContent>
        <DialogHeader className='text-muted-foreground'>
          <DialogTitle className='text-primary'>Crear Organización</DialogTitle>
          <DialogDescription>Crea una nueva organización.</DialogDescription>
        </DialogHeader>
        <NewTeamForm setShowNewTeamDialog={setShowNewTeamDialog} />
      </DialogContent>
    </Dialog>
  );
}
