    ...
    <Steps>
      ...
      <Step title="Create a new assistant">
        ...
        <Frame caption="Creating a new assistant">
          <img src="file:fd0f6c0e-d90f-4381-9a35-a7dd915f1265" />
        </Frame>
      </Step>
    ...
    <Steps>
      <Step title="Create a phone number">
        ...
        <Frame caption="Create a phone number">
          <img src="file:428793cb-9619-4a66-92c8-08f78ea742c8" />
        </Frame>
      ...
      <Step title="Attach your assistant to the number">
        ...
        <Frame>
          <img src="file:9c67f2aa-25ba-4822-b461-3134e65f391f" />
        </Frame>
      </Step>
    </Steps>
  </Tab>
...
<Steps>
    ...
    <Tabs>
      <Tab title="Dashboard">
        ...
        <Frame caption="Making an outbound call">
          <img src="file:aed84b7b-adee-49dc-9119-52a45beeec12" />
        </Frame>
      </Tab>
  ...
  <Step title="Test web calling (optional)">
    ...
    <Frame>
      <img src="file:f2914bd0-af13-42a8-b25c-71857a7ef1fa" />
    </Frame>
  </Step>
</Steps>
