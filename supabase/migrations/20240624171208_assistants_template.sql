...
CREATE TABLE IF NOT EXISTS public.assistants_template
(
...
CREATE TRIGGER set_assistants_template_timestamp
    BEFORE INSERT OR UPDATE ON public.assistants_template
    FOR EACH ROW
EXECUTE PROCEDURE basejump.trigger_set_timestamps();

-- protect the updated_by and created_by columns by setting them to be read-only and managed by a trigger
CREATE TRIGGER set_assistants_template_user_tracking
    BEFORE INSERT OR UPDATE ON public.assistants_template
    FOR EACH ROW
...
----------------
-- create policy "All logged in users can select" on public.assistants_template
--     for select
--     to authenticated
--     using (true);
...
----------------
-- create policy "All authenticated and anonymous users can select" on public.assistants_template
--     for select
...
--------------
-- create policy "Account members can select" on public.assistants_template
--     for select
--     to authenticated
--     using (
...
----------------
-- create policy "Account members can insert" on public.assistants_template
--     for insert
--     to authenticated
--     with check (
--     (account_id IN ( SELECT basejump.get_accounts_with_role()))
...
---------------
-- create policy "Account members can update" on public.assistants_template
--     for update
--     to authenticated
--     using (
--     (account_id IN ( SELECT basejump.get_accounts_with_role()))
...
----------------
-- create policy "Account members can delete" on public.assistants_template
--     for delete
--     to authenticated
--     using (
--     (account_id IN ( SELECT basejump.get_accounts_with_role()))
...
----------------
-- create policy "Account owners can delete" on public.assistants_template
--     for delete
--     to authenticated
--     using (
