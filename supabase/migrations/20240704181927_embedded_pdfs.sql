...
CREATE TABLE IF NOT EXISTS public.embedded_pdfs
(
...
----------------
-- create policy "All logged in users can select" on public.embedded_pdfs
--     for select
--     to authenticated
--     using (true);
...
----------------
-- create policy "All authenticated and anonymous users can select" on public.embedded_pdfs
--     for select
...
--------------
-- create policy "Account members can select" on public.embedded_pdfs
--     for select
--     to authenticated
--     using (
...
----------------
-- create policy "Account members can insert" on public.embedded_pdfs
--     for insert
--     to authenticated
--     with check (
--     (account_id IN ( SELECT basejump.get_accounts_with_role()))
...
---------------
-- create policy "Account members can update" on public.embedded_pdfs
--     for update
--     to authenticated
--     using (
--     (account_id IN ( SELECT basejump.get_accounts_with_role()))
...
----------------
-- create policy "Account members can delete" on public.embedded_pdfs
--     for delete
--     to authenticated
--     using (
--     (account_id IN ( SELECT basejump.get_accounts_with_role()))
...
----------------
-- create policy "Account owners can delete" on public.embedded_pdfs
--     for delete
--     to authenticated
--     using (
